...
export const TwoColLayout = ({
  ...
  return (
    <section
      ...
      } flex lg:gap-[120px]   flex-col justify-around items-center shadow-inner box-shadow py-[80px] rounded-[24px] z-30 lg:px-[70px]  mb-[20px]
    ...
    >
      ...
      <div className="flex flex-col mt-[20px] md:mt-[0px] justify-center items-center order-2">
        <FadeInWhenVisible>
          <img src={image} alt={title} className="w-[350px] h-[492]" />
        </FadeInWhenVisible>
      </div>
    </section>
  );
