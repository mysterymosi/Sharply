  ...
  return (
    <main>
      <section
        ...
        <NavigationBar />
        <div className="px-[25px] items-center flex lg:flex-row flex-col md:h-full h-4/5 justify-center text-black ">
      ...
      <div className="lg:max-w-[800px] md:w-full  m-auto  h-full ">
        <FadeInWhenVisible>
          <p className=" lg:text-[24px] text-[16px] text-[#424242] md:my-[120px] px-[24px] mt-0  font-medium mb-[58px]">
            The Little card works just like a regular debit card but for
            children. It gives an added advantage of being able to set
            boundaries like spending limits, track spending location and so much
            more.
          </p>
        </FadeInWhenVisible>
      </div>
          ...
          <div className="max-w-[40ch] flex justify-center  md:px-0 flex-col order-last md:order-1  lg:mt-0 ">
            <EnterFromLeft>
              ...
              <p className="text-[18px] mb-[13px]">
                This card can be enabled for all types of debit card
                transactions like paying online, using a POS, or withdrawing
                from an ATM.
              </p>
      ...
      lg:mb-[100px] mb-[20px] `}>
          ...
          <div className="flex basis-3/6 mt-[20px] md:mt-[0px]  justify-center items-center">
            <FadeInWhenVisible>
              <img
                src={"/images/school-children.svg"}
                alt={"school children"}
              />
            </FadeInWhenVisible>
          </div>
