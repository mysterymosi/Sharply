            ...
            <EnterFromLeft>
              ...
              <div className="max-w-[440px]">
                <p className="mt-6 text-black font-normal text-sm  ">
                  Birthday coming up? Graduation? Or your child just really
                  wants that latest game? Create giftlinks to receive money from
                  family & friends for any and everything
                </p>
      ...
      lg:mb-[100px] mb-[20px] `}>
          ...
          <div className="flex flex-col mt-[20px] md:mt-[0px] justify-center items-center order-2">
            <FadeInWhenVisible>
              {" "}
              <img
                src={"/images/giftlink.svg"}
                alt={"phone with giftlink creation form "}
              />
            </FadeInWhenVisible>
          </div>
        </div>
